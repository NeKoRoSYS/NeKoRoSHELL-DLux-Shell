...
Slider {
    ...
    background: Item {
        ...
        Canvas {
            ...
            Connections {
                ...
                function onWaveAnimationPhaseChanged() { wavyCanvas.requestPaint(); }
                function onWaveTransitionChanged() { wavyCanvas.requestPaint(); }
            }
        }
        ...
        Canvas {
            ...
            onPaint: {
                ...
                if (inactiveWidth <= 0 || inactiveStartPos >= 1) return;
            ...
            Connections {
                target: slider
                function onVisualPositionChanged() { inactiveCanvas.requestPaint(); }
            }
        }
    }
    ...
    handle: Rectangle {
        ...
        Behavior on scale {
            NumberAnimation { duration: 200; easing.bezierCurve: [0.2, 0, 0, 1, 1, 1] }
        }
        Behavior on opacity {
            NumberAnimation { duration: 200; easing.bezierCurve: [0.2, 0, 0, 1, 1, 1] }
        }
